/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c70cbda05d9c7c83d97471ac578745f)
// Runtime types generated with workerd@1.20260128.0 2026-01-01 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DocumentProcessor";
	}
	interface StagingEnv {
		...
		ENVIRONMENT: string;
		DOCUMENT_PROCESSOR: DurableObjectNamespace /* DocumentProcessor from portfolio-document-processor-staging */;
	}
	interface ProductionEnv {
		...
		R2_SECRET_ACCESS_KEY: string;
		ENVIRONMENT: string;
		DOCUMENT_PROCESSOR: DurableObjectNamespace /* DocumentProcessor from portfolio-document-processor-prod */;
	}
	interface Env {
		OPENAI_API_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		...
		VECTORIZE: VectorizeIndex;
		PROCESSING_QUEUE: Queue;
		DOCUMENT_PROCESSOR: DurableObjectNamespace /* DocumentProcessor from portfolio-document-processor-staging */ | DurableObjectNamespace /* DocumentProcessor from portfolio-document-processor-prod */ | DurableObjectNamespace /* DocumentProcessor from portfolio-document-processor */;
	}
}
