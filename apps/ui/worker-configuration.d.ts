/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd7770de46b9db2432133888e70443de)
// Runtime types generated with workerd@1.20260128.0 2026-01-01 nodejs_compat
declare namespace Cloudflare {
	interface ProductionEnv {
		CHAT_SERVICE: Fetcher /* chat-service-prod */;
	}
	interface Env {
		CHAT_SERVICE: Fetcher /* chat-service-prod */ | Fetcher /* chat-service-staging */;
		VALUE_FROM_CLOUDFLARE?: "Hello from TanStack Start";
	}
}
